      ...
      return (
        <div className="">
            ...
            <dialog id="my_modal_2" className="modal">
                <div className="modal-box overflow-x-hidden overflow-y-hidden"
                    ...
                    <div className="flex w-full mt-10 justify-between">
                        <div className="w-[48%]">
                            <div className="w-full flex rounded-full bg-[#f3f4f6]">
                                <button className="rounded full bg-[#0166FF] w-[50%] h-[40px] flex justify-center items-center text-white font-semibold text-[15px] px-[10px] py-2"
                                style={{
                                ...
                                onClick={handleClick}
                                >Income</button>
                                <button className="rounded full bg-slate-200 w-[50%] flex justify-center items-center text-white font-semibold text-[15px] px-[10px] py-2"
                                style={{
